...
export class CitGanttComponent {
  constructor() {
  ...
  ngAfterViewInit() {
    this.dispose();
    this.control = new Cit.Gantt(this.id);
    this.updateOptions();
...
CitGanttComponent.ɵfac = i0.ɵɵngDeclareFactory({
  minVersion: '12.0.0',
  version: '13.1.3',
  ngImport: i0,
  type: CitGanttComponent,
  deps: [],
  target: i0.ɵɵFactoryTarget.Component,
});
CitGanttComponent.ɵcmp = i0.ɵɵngDeclareComponent({
  minVersion: '12.0.0',
  version: '13.1.3',
  type: CitGanttComponent,
  selector: 'cit-gantt',
